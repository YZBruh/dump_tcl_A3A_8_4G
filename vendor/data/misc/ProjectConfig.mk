...
CUSTOM_HAL_IMGSENSOR = gc5025a_mipi_raw gc2385_mipi_raw a3a84g_cxt_gc5025a_mipi_raw a3a84g_cxt_gc2385_mipi_raw
...
CUSTOM_HAL_MAIN_IMGSENSOR = gc5025a_mipi_raw a3a84g_cxt_gc5025a_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9714af
CUSTOM_HAL_MSENSORLIB =
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = ad5820af
CUSTOM_HAL_SUB_IMGSENSOR = gc2385_mipi_raw a3a84g_cxt_gc2385_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc5025a_mipi_raw gc2385_mipi_raw a3a84g_cxt_gc5025a_mipi_raw a3a84g_cxt_gc2385_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc5025a_mipi_raw a3a84g_cxt_gc5025a_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = gc2385_mipi_raw a3a84g_cxt_gc2385_mipi_raw
...
CUSTOM_MODEM = a3a84g_sp_lwctg_umoly0142_prod
...
MTK_BUILD_VERNO = alps-mp-o1.mp1-V1.141.2_tb8765ap1.bsp_P24
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#[BUGFIX]-Add-BEGIN by SCDTABLET.changxun.qin,03/21/2018,6128007
#[HOMO][ALWE] Number 122 is recognised as Emergency calls, but it's Vodafone Spain customer care number
MTK_CTA_SET = no
#[BUGFIX]-Add-END by SCDTABLET.changxun.qin
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
#[TASK]-Add-BEGIN by fenli@tcl.com, 2018/05/21, Task-6316811
MTK_DYNAMIC_SBP_SUPPORT = yes
#[TASK]-Add-END by fenli@tcl.com, Task-6316811
MTK_EAP_SIM_AKA = yes
MTK_ECCCI_C2K = yes
...
#[FEATURE]-Add-BEGIN by SCDTABLET.meiqin,03/15/2018,6067143
...
#meiqin modify for mini 20180306
...
MTK_RUNNING_BOOSTER_DEFAULT_ON = on
MTK_RUNNING_BOOSTER_SUPPORT = on
...
#[FEATURE]-Mod by SCDTABLET.(zhaofeng),27/04/2018,task6272500,enable TEE
MTK_TEE_SUPPORT = yes
...
#[BUGFIX]-Mod-BEGIN by SCDTABLET.(bo.yang@tcl.com),05/25/2018,6330026
MTK_NLP_SUPPORT = no
#[BUGFIX]-Mod-END by SCDTABLET.(bo.yang@tcl.com),05/25/2018,6330026
...
#meiqin add for partition 20180306
TCL_TCTPERSIST_PARTITION_SUPPORT = yes
TCL_SIMLOCK_PARTITION_SUPPORT = yes
#zhi.li.sz@tcl.com add for fota system part 20180313
TCL_OTA_UPDATER = yes
#jianqin.xiong add for cdrom 20180314,task:6107213
MTK_BICR_SUPPORT = yes
#added by shujing.jin for tclPlugin on 2018/03/20
TCL_OPTR_SPEC_SEG_DEF = OP00_SPEC0200_SEGDEFAULT
#zhicheng.huang,support sip voip feature
OPPO_SIP_SUPPORT = yes
#mingweizheng@tcl.com add for support play sdp file 2018-05-17, defect 6209019
MTK_SDP_PLAYBACK_SUPPORT = yes
